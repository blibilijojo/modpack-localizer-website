...
const allTexts = {
  ...
  en: {
    title: "Modpack Localizer Pro - A Professional Localization Workbench",
    description: "A professional workbench for Minecraft modpack localization. It deeply integrates powerful AI translation and community resources with fine-grained manual proofreading and project management (save/load), providing a full-circle localization experience for both modpack creators and players.",
    latest_release: "Download Latest Release",
    feature_showcase: "Feature Showcase",
    manual_workbench: "Manual Translation Workbench",
    manual_workbench_desc: "A professional three-pane layout for efficiently reviewing, editing, and proofreading thousands of entries, sorted by mod.",
    dict_search: "Community Dictionary Search",
